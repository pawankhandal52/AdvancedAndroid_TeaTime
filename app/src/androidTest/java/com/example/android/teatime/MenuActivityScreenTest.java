...
public class MenuActivityScreenTest {
    ...
    @Rule public ActivityTestRule<MenuActivity> mMenuActivityActivityTestRule = new ActivityTestRule<>(MenuActivity.class);
    ...
    public void clickGridViewItem_OpensOrderActivity() {
        ...
        //2 now check tea name is same on previois grid view
